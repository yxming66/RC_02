...
class Link {
 public:
  ...
  float qmin() const { return qmin_; }
  float qmax() const { return qmax_; }
  Joint_Type_e type() const { return type_; }
  float m() const { return m_; }
  Matrixf<3, 1> rc() const { return rc_; }
  Matrixf<3, 3> I() const { return I_; }
