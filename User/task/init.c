...
void Task_Init(void *argument) {
  ...
  task_runtime.thread.cpp_rm_main = osThreadNew(Task_cpp_rm_main, NULL, &attr_cpp_rm_main);
  task_runtime.thread.chassis_main = task_runtime.thread.cpp_rm_main;
  ...
  task_runtime.thread.pc_comm = osThreadNew(Task_pc_comm, NULL, &attr_pc_comm);
    ...
    task_runtime.thread.ore_store = task_runtime.thread.cpp_rm_main;
