...
typedef enum {
    ...
    AUTO_ORE_DEBUG_REQUEST_ABORT = 1,
    AUTO_ORE_DEBUG_REQUEST_STORE = 2,
    AUTO_ORE_DEBUG_REQUEST_RELEASE = 3,
    AUTO_ORE_DEBUG_REQUEST_RELEASE_LIFT_DETECT = 4,
    AUTO_ORE_DEBUG_REQUEST_CHAMBER = 5,
    AUTO_ORE_DEBUG_REQUEST_PICK_POS_400 = 6,
    AUTO_ORE_DEBUG_REQUEST_PICK_POS_200 = 7,
    AUTO_ORE_DEBUG_REQUEST_PICK_NEG_200 = 8,
    AUTO_ORE_DEBUG_REQUEST_PICK_STORE_POS_400 = 9,
    AUTO_ORE_DEBUG_REQUEST_PICK_STORE_POS_200 = 10,
    AUTO_ORE_DEBUG_REQUEST_PICK_STORE_NEG_200 = 11,
    AUTO_ORE_DEBUG_REQUEST_ROD_SPEARHEAD = 12,
    AUTO_ORE_DEBUG_REQUEST_ROD_SPEARHEAD_STEP1 = 13,
    AUTO_ORE_DEBUG_REQUEST_ROD_SPEARHEAD_STEP2 = 14,
    AUTO_ORE_DEBUG_REQUEST_ROD_DOCK_WAIT = 15,
    AUTO_ORE_DEBUG_REQUEST_SICK_CORRECT_ROD_SPEARHEAD_POS1 = 16,
    AUTO_ORE_DEBUG_REQUEST_SICK_CORRECT_ROD_SPEARHEAD_POS2 = 17,
    AUTO_ORE_DEBUG_REQUEST_SICK_CORRECT_ROD_SPEARHEAD_POS3 = 18,
    AUTO_ORE_DEBUG_REQUEST_SICK_CORRECT_ROD_SPEARHEAD_POS4 = 19,
    AUTO_ORE_DEBUG_REQUEST_SICK_CORRECT_ROD_SPEARHEAD_POS5 = 20,
    AUTO_ORE_DEBUG_REQUEST_SICK_CORRECT_ROD_SPEARHEAD_POS6 = 21,
    AUTO_ORE_DEBUG_REQUEST_SICK_CORRECT_ORE_RELEASE = 22,
    AUTO_ORE_DEBUG_REQUEST_STEP_ASCEND_200_HEAD = 23,
    AUTO_ORE_DEBUG_REQUEST_STEP_DESCEND_200_HEAD = 24,
    AUTO_ORE_DEBUG_REQUEST_STEP_ASCEND_400_HEAD = 25,
    AUTO_ORE_DEBUG_REQUEST_STEP_DESCEND_400_HEAD = 26,
    AUTO_ORE_DEBUG_REQUEST_STEP_PICK_STORE_ASCEND_200_HEAD = 27,
    AUTO_ORE_DEBUG_REQUEST_STEP_PICK_STORE_DESCEND_200_HEAD = 28,
    AUTO_ORE_DEBUG_REQUEST_STEP_PICK_STORE_ASCEND_400_HEAD = 29,
    AUTO_ORE_DEBUG_REQUEST_STEP_DROP_STORE_ASCEND_200_HEAD = 30,
...
typedef struct {
    ...
    volatile uint16_t front_adc_raw;
    volatile uint16_t rod_side_adc_raw;
    volatile uint16_t bottom_adc_raw;
    volatile uint16_t unused_adc_raw;
    volatile bool front_valid;
    volatile bool rod_side_valid;
    volatile bool bottom_valid;
    volatile bool unused_valid;
    volatile uint8_t front_ore_sample_valid;
