...
typedef enum {
  ...
  AUTO_CTRL_TEMPLATE_ASCEND_200_STD,
  AUTO_CTRL_TEMPLATE_DESCEND_200_STD,
  AUTO_CTRL_TEMPLATE_ASCEND_200_NO_FRONT_SICK,
  AUTO_CTRL_TEMPLATE_DESCEND_200_NO_FRONT_SICK,
