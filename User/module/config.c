...
Config_RobotParam_t robot_config = {
    ...
    .ore_store_param = {
        ...
        .pid = {
            .position_pid = {
                [ORE_STORE_AXIS_PLATFORM] = {.k = 1.0f, .p = 40.0f, .i = 0.0f, .d = 0.0f, .i_limit = 5.0f, .out_limit = 45.0f, .d_cutoff_freq = 80.0f, .range = 0.0f},
                [ORE_STORE_AXIS_GATE_LEFT] = {.k = 1.0f,   .p = 22.0f, .i = 0.0f, .d = 0.0f, .i_limit = 0.0f, .out_limit = 40.0f, .d_cutoff_freq = 80.0f, .range = 0.0f},
                [ORE_STORE_AXIS_GATE_RIGHT] = {.k = 1.0f,  .p = 22.0f, .i = 0.0f, .d = 0.0f, .i_limit = 0.0f, .out_limit = 40.0f, .d_cutoff_freq = 80.0f, .range = 0.0f},
                [ORE_STORE_AXIS_TRACK_LEFT] = {.k = 1.0f,  .p = 25.0f, .i = 0.0f, .d = 0.0f, .i_limit = 0.0f, .out_limit = 40.0f, .d_cutoff_freq = 80.0f, .range = 0.0f},
                [ORE_STORE_AXIS_TRACK_RIGHT] = {.k = 1.0f, .p = 25.0f, .i = 0.0f, .d = 0.0f, .i_limit = 0.0f, .out_limit = 40.0f, .d_cutoff_freq = 80.0f, .range = 0.0f},
            },
            .velocity_pid = {
        ...
        .controller = { 
            .sample_freq = 500.0f, 
            .position_to_velocity_limit = {45.0f, 40.0f, 40.0f, 40.0f, 40.0f},
            .velocity_to_torque_limit = {2.50f, 1.80f, 1.80f, 1.80f, 1.80f},
        ...
        .limit = {
            ...
            .move_velocity_rad_s = {45.0f, 40.0f, 40.0f, 40.0f, 40.0f},
            .move_accel_rad_s2 = {60.0f, 60.0f, 60.0f, 80.0f, 80.0f},
            .arrive_threshold_rad = {0.08f, 0.06f, 0.06f, 0.15f, 0.15f},
        },
        .power_on = {
