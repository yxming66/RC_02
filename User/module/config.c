...
Config_RobotParam_t robot_config = {
    ...
    .pole_param = {
        ...
        .preset = {
            ...
            .step_200_front_retract = {0.2f, 5.40230465f},
            /* 200mm 上台阶四杆全收位。 */
            ...
            .step_400_front_retract = {0.1f, 10.8f},
            /* 400mm 上台阶四杆全收位。 */
            .step_400_all_retract = {0.2f, 0.1f},
    ...
    .camera_yaw_param = {
        [CAMERA_YAW_RIGHT] = {
            ...
            .encoder_zero_offset_rad = 4.83105898f,
            .pid = {
                .yaw_pid = {
                    .k = 1.0f,
                    .p = 2.0f,
