...
Config_RobotParam_t robot_config = {
  .chassis_param = {
	...
	.pole_param = {
      ...
      .auto_ctrl_param = {
        .climb_forward_speed = 0.35f,
        .climb_forward_kick_speed = 0.35f,
        .climb_rear_retract_speed = 0.15f,
        .pole_extend_settle_ms = 900u,
        .front_photo_timeout_ms = 2500u,
        .front_retract_settle_ms = 900u,
        .rear_photo_timeout_ms = 2500u,
        .rear_retract_move_ms = 600u,
      },
    .arm_param = {
      .joint3_cali = {
